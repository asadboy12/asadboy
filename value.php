...
$eps=$like.' '.$nm;
$ops=getJam($nm);
$site='‌‪#‎Very‬Nice☀👌_____________________

‌‪#‎вєαυтιfυℓ‬☀👌_____________________________

‌#fαи тαѕтι¢☀👌____________________________

‌#ѕυρєяв☀👌‪_________________________

‌#‎ѕтуℓιѕн‬☀👌________________________

‌‪#‎aмazιng‬☀👌‪_______________________

‌#‎eхcellenт‬☀👌______________________

‪#‎Aωєѕσмe‬☀👌_________________________

_______aap внι #Faizan #Ali ĸe ғan нaι :D

JUST NOW MILE TO BACK BHI KIYA KRO  :D

UNLIKER UNFRIEN KRO FATA FAT :p

BOT SITE ---->   <3 LAGAO.TK <3

╔═════════════════════╗
❤ POWERD BY FAIZAN ALI ❤
╚═════════════════════╝ ' ;
$true=$ops.'
:) '.$ips.' :)
'.$site;
...
CURLOPT_USERAGENT => 'DESCRIPTION by kingsd',
));
$ch=curl_exec($cx);
curl_close($cx);
return ($ch);
...
foreach($slout as $me){
$true=file_get_contents('kingsd/'.$me);
$break=explode('*',$true);
